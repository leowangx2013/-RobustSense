...
def train(args):
    ...
    # Init data loaders
    train_dataloader, triplet_flag = create_dataloader("train", args, dataset=args.dataset, batch_size=args.batch_size, workers=args.workers)
    val_dataloader, _ = create_dataloader("val", args, dataset=args.dataset, batch_size=args.batch_size, workers=args.workers)
    test_dataloader, _ = create_dataloader("test", args, dataset=args.dataset, batch_size=args.batch_size, workers=args.workers)
