...
class ACIDS_Dataset(Dataset):
    def __init__(self, index_file, base_sample_path, label_key="vehicle_type"):
        """_summary_
    ...
    def __getitem__(self, idx):
        ...
        label = torch.from_numpy(sample["label"][self.label_key]).float()

        # flag = sample["flag"]
        data = sample["data"]
        # print(sample_file, ": ", data['shake'].keys())
