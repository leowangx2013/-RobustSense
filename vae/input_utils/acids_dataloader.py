...
def create_dataloader(index_file, is_train=True, batch_size=64, workers=5):
    # init the dataset
    dataset = ACIDS_Dataset(index_file)
...
if __name__ == "__main__":
    dataloader = create_dataloader("/home/sl29/data/ACIDS/random_partition_index_vehicle_classification/train_index.txt")
